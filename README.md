...
- Node.js 20 or newer.
- pnpm 11 or newer.
- Codex CLI/app-server 0.144.1 or newer; 0.149.0 is the recommended stable version.
...
This branch supports Codex CLI 0.144.1 as its minimum compatibility baseline and recommends Codex CLI 0.149.0. SDK and CLI versions are tracked separately because OpenAI may not publish them in lockstep.
...
Both Dockerfiles pin Codex CLI to the recommended 0.149.0 stable version unless `CODEX_CLI_VERSION` is overridden at build time. Teleco retains a minimum compatibility baseline of 0.144.1.
