  ...
  const sections = [
    {
      ...
      commands: [
        ...
        ["/reconnect", "Refresh MCP runtime; reconnect app-server when unsupported"],
        ["/rename <name>", "Rename the current Codex thread"],
        ["/pin", "Pin the current Codex thread"],
        ["/unpin", "Unpin the current Codex thread"],
        ["/compact", "Show compact controls; use /compact run to execute"],
        ...
        ["/ask <prompt>", "Send command-looking text as prompt; alias: /prompt"],
      ],
    },
    {
      title: "🤖 Model",
